---
name: code-reviewer
description: Reviews code diffs and files for bugs, security vulnerabilities (SQL injection, XSS, insecure deserialization), code smells, N+1 queries, naming issues, and architectural concerns, producing a structured report with prioritized, actionable feedback. Use when reviewing pull requests, conducting code-quality audits, identifying refactoring opportunities, or checking for security issues.
license: MIT
