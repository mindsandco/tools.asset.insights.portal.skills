...
Invoke the fullstack-dev-skills:code-simplification skill.
...
If tests fail after a simplification, revert that change and reconsider. Use `code-reviewer` to review the result.